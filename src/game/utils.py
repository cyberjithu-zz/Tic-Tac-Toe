...
'''
The name generator function is the python version of name generator which is already
...
def gen_name():
    '''create a random name from left and right list seperated by an underscore( _ ).'''
    return random.choince(left) + '_' + random.choice(right)
